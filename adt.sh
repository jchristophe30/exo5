...
echo_info "DEPLOYMENT_DATABASE_TYPE DEPLOYMENT_DATABASE_TYPE DEPLOYMENT_DATABASE_TYPE adt"
echo_info "${DEPLOYMENT_DATABASE_TYPE}"

echo_info "DEPLOYMENT_APACHE_VHOST_ALIAS DEPLOYMENT_APACHE_VHOST_ALIAS DEPLOYMENT_APACHE_VHOST_ALIAS"
echo_info "${DEPLOYMENT_APACHE_VHOST_ALIAS}"
